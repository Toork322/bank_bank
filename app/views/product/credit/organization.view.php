                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form style="text-align: center;" method="POST">
                            <h5>Данные по кредиту</h5>
                            <label class="form-label">Введите сумму кредита</label>
                            <input name="credit_sum" type="number" class="form-control">
